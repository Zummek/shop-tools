...
const endpoint = '/api/v1/ecommerce/erli/offers/';
export const erliOffersQueryKeyBase = 'erli-offers';
...
export const useGetErliOffers = (options: Options = {}) => {
  ...
  const { data, isLoading, isFetching, refetch } = useQuery({
    queryKey: [erliOffersQueryKeyBase, query, page, unmatchedOnly, activeOnly],
    queryFn: async () => {
