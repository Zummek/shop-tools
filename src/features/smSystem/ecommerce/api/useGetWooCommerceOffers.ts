...
const endpoint = '/api/v1/ecommerce/woocommerce/offers/';
export const wooCommerceOffersQueryKeyBase = 'woocommerce-offers';
...
export const useGetWooCommerceOffers = (options: Options = {}) => {
